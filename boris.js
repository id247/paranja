(function(){
	...
	var boris = document.createElement('img');
	boris.src = 'https://ad.csdnevnik.ru/special/staging/adfox/boris4.gif';
	boris.style.zIndex = '1000';
	boris.style.position = 'fixed';
	boris.style.top = 0;
	boris.style.right = 0;
	boris.style.transform = 'translateX(200px) ';
	boris.style.transition = 'transform 3.8s ease-in-out';
	parentDoc.body.appendChild(boris);
	setTimeout( function(){
			boris.style.transform = 'translateX(0px) ';
	}, 100);
